...
Models are stored in versioned directories (v1, v2). The system allows routing traffic to different model versions to enable:
...
Here is your production-ready README.md file. I have organized it with professional Markdown formatting to ensure it looks great on platforms like GitHub or GitLab.
...
Upload: User uploads an image via the UI or API.
...
🌐 NGINX Reverse Proxy
NGINX acts as the gateway, routing traffic to the internal API and serving as a foundation for future SSL termination and load balancing.
location / {
...
📁 Project Structure📁 Project Structure📁 Project Structure📁 Project Structure📁 Project Structure
