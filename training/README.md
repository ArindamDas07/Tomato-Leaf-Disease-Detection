...
The original dataset was obtained from Kaggle https://www.kaggle.com/datasets/shylesh101/tomato-leaf-disease
 and already had a train/validation/test split. For this project, the dataset was merged and re-split to create a custom train, validation, and test split.
...
⚠️ Note: The dataset is publicly available on Kaggle. The splits in this project were customized for training and evaluation purposes.
---
